 ...
 */
export const createClaimsTable = (claims: any): any => {
  const claimsObj = {}
  let index = 0
 ...
 */
const populateClaim = (claim: any, value: any, description: any, index: any, claimsObject: any): any => {
  const claimsArray = []
  claimsArray[0] = claim
  claimsArray[1] = value
 ...
 * @returns
 */
const changeDateFormat = (date: any): any => {
